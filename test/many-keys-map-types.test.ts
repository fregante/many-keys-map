...
describe('ManyKeysMap (TypeScript)', () => {
	...
	test('Usage example with various key types and iteration', () => {
	...
	test('Example from readme -- either-or type usage', () => {
	...
	test('Example from readme -- untyped usage', () => {
		const map = new ManyKeysMap();
		testExampleFromReadMe(map);
	});
});
